...
# sheet_name=None表示全部分頁
# 如果要選擇特定的欄位:usecols=["Date","Volume","Order"]
# df = pd.read_excel("prophecy_data.xlsx") #  資料時間:20190601~20210601
# df = pd.read_excel("10year.xlsx") #  資料時間:20110601~20210601
df = pd.read_excel("propfecy_dnn_建模_simple_D\DNN_6m_m1_D.xlsx") #  資料時間:20190601~20210601
...
"""添加层:其实就是 wx+b"""
model.add(tf.keras.layers.Dense(units=300, activation='relu', input_dim=6))
